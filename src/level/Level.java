...
public class Level {
	...
	public Level(File levelFile) throws LevelFileNotFoundException, PropertieNotSetException, PlayerNotSetException, BadPassabilityException {
	...
	public Tile getTile(int x, int y) {
		int color = levelDatas[getTileId(x, y)];
		if (!tileset.containsKey(color))
			tileset.put(color, new Tile(tileSizeIngame));
		return tileset.get(color);
	}
	...
	public void update(Main main, Screen screen) {
		...
		for (Entity entity : entities) {
			entity.basicUpdate(main, screen);
